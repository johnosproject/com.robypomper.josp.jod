...
package com.robypomper.josp.jcp.jslwebbridge.controllers.pub.admin.apis.buildinfo;

import com.robypomper.josp.clients.JCPClient2;
import com.robypomper.josp.jcp.clients.ClientParams;
import com.robypomper.josp.jcp.defs.jslwebbridge.pub.admin.apis.buildinfo.Params20;
import com.robypomper.josp.jcp.defs.jslwebbridge.pub.admin.apis.buildinfo.Paths20;
...
public class Controller20 extends ControllerLinkJSL {
    ...
    @GetMapping(path = Paths20.FULL_PATH_JSLWB_ADMIN_APIS_BUILDINFO, produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = Paths20.DESCR_PATH_JSLWB_ADMIN_APIS_BUILDINFO)
    @ApiResponses(value = {
    ...
    public ResponseEntity<Params20.BuildInfo> getJCPAPIsBuildInfoReq(@ApiIgnore HttpSession session) {
        JSL jsl = getJSL(session.getId());
        try {
            return ResponseEntity.ok(jsl.getAdmin().getJCPAPIsBuildInfo());
