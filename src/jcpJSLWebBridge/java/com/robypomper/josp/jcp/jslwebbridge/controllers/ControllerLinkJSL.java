...
public class ControllerLinkJSL extends ControllerImpl {
    ...
    protected ControllerLinkJSL(String swaggerAPIName, String swaggerAPIVers, String swaggerAPISuffix, String swaggerSubGroupName, String swaggerSubGroupDescr) {
