...
package com.robypomper.josp.jcp.jslwebbridge.controllers.pub.admin.jslwebbridge.buildinfo;

import com.robypomper.josp.clients.JCPClient2;
import com.robypomper.josp.jcp.clients.ClientParams;
import com.robypomper.josp.jcp.defs.jslwebbridge.pub.admin.jslwebbridge.buildinfo.Params20;
import com.robypomper.josp.jcp.defs.jslwebbridge.pub.admin.jslwebbridge.buildinfo.Paths20;
...
public class Controller20 extends ControllerLinkJSL {
    ...
    @GetMapping(path = Paths20.FULL_PATH_JSLWB_ADMIN_JSLWB_BUILDINFO, produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = Paths20.DESCR_PATH_JSLWB_ADMIN_JSLWB_BUILDINFO)
    @ApiResponses(value = {
    ...
    public ResponseEntity<Params20.BuildInfo> getJCPJSLWebBridgeBuildInfoReq(@ApiIgnore HttpSession session) {
        JSL jsl = getJSL(session.getId());
        try {
            return ResponseEntity.ok(jsl.getAdmin().getJCPJSLWebBridgeBuildInfo());
