...
package com.robypomper.josp.jcp.apis.controllers.josp.admin.frontend.executable;
...
public class Controller20 extends ControllerLink {
    ...
    @GetMapping(path = Paths20.FULL_PATH_JCP_FE_EXEC_DISKS)
    @ApiOperation(value = Paths20.DESCR_PATH_JCP_FE_EXEC_DISKS,
            authorizations = @Authorization(
                    value = SwaggerConfigurer.OAUTH_FLOW_DEF_JCP,
                    scopes = @AuthorizationScope(
                            scope = SwaggerConfigurer.ROLE_JCP_SWAGGER,
    ...
    @ApiOperation(value = Paths20.DESCR_PATH_JCP_FE_EXEC_DISK,
            authorizations = @Authorization(
                    value = SwaggerConfigurer.OAUTH_FLOW_DEF_JCP,
                    scopes = @AuthorizationScope(
                            scope = SwaggerConfigurer.ROLE_JCP_SWAGGER,
    ...
    @GetMapping(path = Paths20.FULL_PATH_JCP_FE_EXEC_NETWORKS)
    @ApiOperation(value = Paths20.DESCR_PATH_JCP_FE_EXEC_NETWORKS,
            authorizations = @Authorization(
                    value = SwaggerConfigurer.OAUTH_FLOW_DEF_JCP,
                    scopes = @AuthorizationScope(
                            scope = SwaggerConfigurer.ROLE_JCP_SWAGGER,
    ...
    @ApiOperation(value = Paths20.DESCR_PATH_JCP_FE_EXEC_NETWORK,
            authorizations = @Authorization(
                    value = SwaggerConfigurer.OAUTH_FLOW_DEF_JCP,
                    scopes = @AuthorizationScope(
                            scope = SwaggerConfigurer.ROLE_JCP_SWAGGER,
