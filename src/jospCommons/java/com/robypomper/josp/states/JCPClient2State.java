...
public enum JCPClient2State {
    ...
    /**
     * Join all CONNECTED_ states.
     *
     * @return true if current state is a CONNECTED_ state.
     */
    public boolean isCONNECTED() {
        return this == CONNECTED_ANONYMOUS
                || this == CONNECTED_LOGGED
                ;
    }
    ...
    public boolean isCONNECTING() {
        return this == CONNECTING
                || this == CONNECTING_WAITING_JCP
                || this == CONNECTING_WAITING_AUTH
                ;
    }
